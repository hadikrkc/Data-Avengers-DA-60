...
We also trained machine learning regression models to predict revenue from budget and other pre-release features.
...
## 4. Answer: Does Budget Drive Success?
...
- **Classification variant**: predict whether a film is profitable (ROI > 0) — simpler, more actionable
